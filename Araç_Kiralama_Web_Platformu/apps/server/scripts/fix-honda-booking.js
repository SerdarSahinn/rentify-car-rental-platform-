...
async function fixHondaBooking() {
  try {
    console.log('🔧 Honda Civic booking kullanıcısını düzeltiyorum...');
    
    // Honda Civic booking'ini bul
    ...
    if (!booking) {
      console.log('❌ Honda Civic booking bulunamadı!');
      return;
    }
